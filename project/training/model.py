...
plus `MLP208_KWS` (208→64→8) for the AVR int8 export path in `export.py`.
...
def main() -> None:
    ...
    p.add_argument("--arch", choices=("dscnn", "mlp"), default="dscnn", help="mlp matches AVR kws_model.h (208->64->8).")
    args = p.parse_args()
